...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	...
	// Add bxslider
	wp_enqueue_script( 'bxslider', get_template_directory_uri(). '/assets/javascript/jquery.bxslider.js' );

	// Add Slick
	//wp_enqueue_script( 'slick', get_template_directory_uri() . '/assets/slick/slick.js' );
	//wp_enqueue_script( 'cc-navigation', get_template_directory_uri(). '/assets/javascript/custom/navigation.js' );
