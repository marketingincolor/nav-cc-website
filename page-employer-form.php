...
<?php get_template_part('template-parts/ribbon-mobile'); ?>
 ...
 <?php while ( have_posts() ) : the_post(); ?>
    ...
    <div class="content-wrapper">
        <div id="employer-form" class="row">
            <h1 class="top-header text-center" style="margin-bottom:0rem;">Ready to hire?</h1>
            <p style="text-align:center;">Please fill out the following form to get started with Creative Compass</p>
            <?php get_template_part('template-parts/employer-form' ); ?>
        </div>
