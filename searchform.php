...
<form role="search" method="get" id="searchform" action="<?php echo home_url( '/' ); ?>">
	...
	<div class="input-group">
		<input type="text" class="input-group-field" value="" name="s" id="s" placeholder="<?php esc_attr_e( "Search and hit enter &#xF002;", 'foundationpress' ); ?>" style="font-family:Montserrat Light, sans-serif, FontAwesome" >
